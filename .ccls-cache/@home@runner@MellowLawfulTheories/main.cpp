...
// cout << "****Update Visitor Team Status module*** " << endl;
//        cout << "\nWho is the visiting team: 1 = T1, 2=T2";
//        visitingTeamQuestion = validateInt(visitingTeamQuestion);
//        cin >> visitingTeamQuestion;
//
//        if(visitingTeamQuestion == 1)
